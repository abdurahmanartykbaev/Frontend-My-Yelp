...
import { useFolder } from "../tools/folderHandler.js";
import { useParams, useLocation } from "react-router-dom";

const Navbar = React.lazy(() => import("./Sidebar/Navbar.jsx"));
const ResultCard = React.lazy(() => import("./Table/ListCard.jsx"));
const AddTableCard = React.lazy(() => import("./Table/AddTableCard.jsx"));
          ...
          <div className="peer-folder">
            {childFolders.length > 0 && (
              <div className="peer-folder">
                ...
                <thead className="table-active table-white">
                  <tr>
